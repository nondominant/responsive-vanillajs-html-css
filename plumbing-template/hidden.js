! function(e) {
    ...
    var o = n(6),
        ...
        l = function e(t, n, l) {
            var p, u, f, d, g = t & e.F,
                ...
                y = x[c] || (x[c] = {});
            h && (l = n);
            for (p in l) u = !g && w && void 0 !== w[p], f = (u ? w : l)[p], d = m && u ? s(f, o) : v && "function" == typeof f ? s(Function.call, f) : f, w && a(w, p, f, t & e.U), x[p] != f && r(x, p, d), v && y[p] != f && (y[p] = f)
        };
    ...
    e.exports = function(e, t) {
        ...
        return function(t, s, g) {
            for (var h, b, v = r(t), m = i(v), w = o(s, g, 3), x = a(m.length), y = 0, C = n ? d(t, x) : c ? d(t, 0) : void 0; x > y; y++)
            ...
            l.initialize = function() {
                ...
                if (o.length) {
                    var r = new XMLHttpRequest,
                        a = l.useServiceCore() ? "https://core.service.elfsight.com" : "https://apps.elfsight.com";
                    e.eappsCustomPlatformUrl && (a = e.eappsCustomPlatformUrl), a += "/p/boot/";
                    var s = i.stringify({
                        w: o.join(",")
                    });
